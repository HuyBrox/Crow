...
//xử lí chuỗi json bài tập render ra bài tập và chức năng chấp điểm
const apiElement = document.getElementById("api-google-sheet");
const API =  "https://script.google.com/macros/s/AKfycbx6TvYr1qyHY0nMtO5PpErfGh_Bx2QPWIx47v2HftJPngQqUQtcDT1EbjvkaFoQDkMbbA/exec"
consle.log(API);
